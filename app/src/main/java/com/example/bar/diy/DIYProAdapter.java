...
public class DIYProAdapter extends RecyclerView.Adapter<DIYProAdapter.myviewholder> {

    Context context;
    ArrayList<diymodel> list;
    FirebaseUser user = FirebaseAuth.getInstance().getCurrentUser();

    public DIYProAdapter(android.content.Context context, ArrayList<diymodel> list) {
    ...
    public myviewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new DIYProAdapter.myviewholder(view);
    }
    ...
    public void onBindViewHolder(@NonNull myviewholder holder, int position) {
        ...
        holder.diytvpro.setText(diymodel.getName());
        Glide.with(holder.diyimgpro.getContext()).load(diymodel.getImage()).into(holder.diyimgpro);
        holder.diyimgpro.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        holder.favoritepro_Btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                    ...
                    databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            if (fav_checker == false) {
                                holder.favoritepro_Btn.setImageResource(R.drawable.favorite);
                                ...
                                holder.favoritepro_Btn.setImageResource(R.drawable.favorite_border);
                            }
                        }
    ...
    public class myviewholder extends RecyclerView.ViewHolder {
        ImageView diyimgpro;
        TextView diytvpro;
        ImageButton favoritepro_Btn;

        public myviewholder(@NonNull View itemView) {
            super(itemView);

            diyimgpro = itemView.findViewById(R.id.diyimg);
            diytvpro = itemView.findViewById(R.id.diytv);
            favoritepro_Btn = itemView.findViewById(R.id.favorite_Btn);
        }
    }
}
